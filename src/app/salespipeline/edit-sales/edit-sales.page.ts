...
export class EditSalesPage implements OnInit,OnDestroy {
  ...
  constructor(private route:ActivatedRoute,private navCtrl:NavController,
    private salespipelineService:SalespipelineService,private router:Router,
  ...
  ngOnInit() {
    this.route.paramMap.subscribe((paramMap) => {
      ...
      this.isLoading=true;
      this.salespipelineSub= this.salespipelineService.getSalespipeline(paramMap.get("salesId")).subscribe(sales=>{
      ...
      this.form = new FormGroup({
        ...
        potentialStatus: new FormControl(this.salespipeline.potentialStatus, {
          updateOn: "blur",
          validators: [Validators.required],
        }),
        closuredate: new FormControl(new Date(this.salespipeline.closuredate).toISOString(), {
          updateOn: "blur",
          validators: [Validators.required],
        }),
...
this.alertCtrl.create({
  ...
  message: "Salespipeline could not be fetch. Please try that later.",
