...
import { DCDetail, DCDetailModel, DCMaterial, Invoice, InvoiceMonth } from '../salespipeline.model';
...
export class InvoiceModalComponent{
    ...
    mergemat.materials.forEach((m, index) => {
      ...
      mat.push(
        ...
        },
        {
          ...
          fontSize: 10,
          alignment: 'right',
          borderColor: (mergemat.materials.length-1)==index?
  ...
  let totrows=35;
  totrows=totrows<subtable.body.length?subtable.body.length:totrows-subtable.body.length;
  ...
  table.body.push([
    { text: 'Amount Chargeable (in words)', colSpan: 7, fontSize:10,
    ...
    '',
    '',
    { text: 'E. & O.E',fontSize:10,borderColor: ['#ffffff','#000000', '#000000','#ffffff']} as unknown,
  ]);
  table.body.push([
    { text: 'INR '+converter.toWords(totamt).toUpperCase() + ' ONLY', colSpan: 8, bold:true,
    fontSize:10,
...
table.body.push([
  {
  text: 'Tax Amount (in words) :',  fontSize:10,
  borderColor: ['#000000','#ffffff', '#ffffff','#ffffff']
 }as unknown,
  { text: 'INR '+converter.toWords(tax).toUpperCase() + ' ONLY',
  colSpan: 7, fontSize:10,bold:true,
...
table.body.push([
{ text: '',  fontSize:12,colSpan:3,borderColor: ['#000000','#ffffff', '#ffffff','#ffffff']},
'','',
 { text: 'Companys Bank Details:',  fontSize:10,colSpan:5,borderColor: ['#ffffff','#ffffff', '#000000','#ffffff']}as unknown,
'','','',''
]);
table.body.push([
  { text: '',colSpan:3},
   '',
   '',
    { text: 'Bank Name:',  fontSize:10,colSpan:3,
    borderColor: ['#ffffff','#ffffff', '#ffffff','#ffffff']}as unknown,
   '',
   '',
   { text: branch.bankName,  fontSize:10,colSpan:2,bold:true,
   borderColor: ['#ffffff','#ffffff', '#000000','#ffffff']},
   ''
]);
table.body.push([
  { text: '',colSpan:3, borderColor: ['#000000','#ffffff', '#ffffff','#ffffff']},
   '',
   '',
    { text: 'A/c No.',  fontSize:10,colSpan:3,
    borderColor: ['#ffffff','#ffffff', '#ffffff','#ffffff']},
   '',
   '',
   { text: branch.accNo,  fontSize:10,colSpan:2,bold:true,
   borderColor: ['#ffffff','#ffffff', '#000000','#ffffff']}as unknown,
   ''
]);
  ...
  table.body.push([
    ...
    '',
    '',
    {text:'',colSpan:5, borderColor: ['#000000', '#ffffff', '#000000', '#ffffff']},
    '',
    '',
    '',
  ]);
  table.body.push([
    {text:'',colSpan:3, borderColor: ['#000000', '#ffffff', '#000000', '#000000']},
    '',
    '',
    {
  ...
  table.body.push([
   ...
   this.insertInvoice(req,this.dclist,amt,tax,totamt,docDefinition)
  }
  ...
  insertInvoice(req:DCDetailModel,selectedDC:DCDetailModel[],amt:number,tax:number,totamount:number,docDefinition:any){
