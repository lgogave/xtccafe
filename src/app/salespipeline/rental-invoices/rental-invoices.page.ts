...
import { ClientSalesPipeline, DCMaterial, InvoiceMonth, ReceiptBook, RentalInvoice,Location, BillingDetail, BillingRate, GSTReceiptBook } from '../salespipeline.model';
